...
<html class="fixed">
    ...
    <head>
        <!-- Basic -->
        <meta charset="UTF-8">
        <title>Mail Page | Baus Gear Admin</title>
                                ...
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <p class="panel-subtitle">
                                            <a href="btnDashboard.htm"> Dashboard </a>
                                        </p>
                                    </header>
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Body <span class="required">*</span></label>
                                            <div class="col-sm-9">
                                    ...
                                    <footer class="panel-footer">
                                        <div class="row">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <input type="submit"  class="btn btn-primary" name="btnSendMailTo" value="Send"/>
