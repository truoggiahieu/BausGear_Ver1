...
<html class="fixed">
    ...
    <head>
        ...
        <title>Catagories Page | Baus Gear Admin</title>
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-md">
                                        <form action="btnAddCatagories.htm">
                                            <button value="btnAddCatagories" class="btn btn-primary">Add New Catagories <i class="fa fa-plus"></i></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            <table class="table table-bordered table-striped mb-none" id="datatable-editable">
                                <thead>
                                    <tr>
                                        <th>Code Catagories</th>
                                        <th>Name Catagories</th>
                                        <th>Name Brand</th>
                                        <th>Actions</th>
                                ...
                                <tbody>
                                    <c:forEach var="rows" items="${listCatagories}">

                                        <tr class="gradeX">
                                            <td>${rows.idCatagories}</td>
                                            <td>${rows.nameCatagories}</td>
                                            <td>${rows.nameBrand}</td>
                                            <c:url var="editCatagories" value="edit.htm">
                                                <c:param name="txtIdCatagories" value="${rows.idCatagories}"/>
                                                <c:param name="txtNameCatagories" value="${rows.nameCatagories}"/>
                                                <c:param name="txtNameBrand" value="${rows.nameBrand}"/>
                                            </c:url>
                                            <td class="actions">
                                                <a href="${editCatagories}"><i class="fa fa-pencil"></i></a>
                                                    <c:url var="delete" value="deleteCatagories.htm">
                                                        <c:param name="idCatagories" value="${rows.idCatagories}"/>
                                                    </c:url>
