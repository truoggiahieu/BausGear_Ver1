...
<html class="fixed">
    ...
    <head>
        <!-- Basic -->
        <meta charset="UTF-8">
        <title>Add Staffs Page | Baus Gear Admin</title>
                    ...
                    <header class="page-header">
                        ...
                        <div class="right-wrapper pull-right">
                            <ol class="breadcrumbs">
                                ...
                                <li><span>Create Catagories</span></li>
                            </ol>
                            ...
                            <form  id="form" action="Ahihihi.htm" class="form-horizontal">
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <h2 class="panel-title">Create New Staff</h2>
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="txtUsernameAdmin" class="form-control"  required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Password : <span class="required">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="password" name="txtPasswordAdmin" class="form-control" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Name : <span class="required">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" name="txtNameAdmin" class="form-control"  required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">File : <span class="required">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="file" name="txtImageAdmin" class="form-control"  required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="txtEmailAdmin" class="form-control" required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Address : <span class="required">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" name="txtAddressAdmin" class="form-control"  required/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Phone : <span class="required">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" name="txtPhoneAdmin" class="form-control" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <footer class="panel-footer">
                                        <div class="row">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <input type="submit"  class="btn btn-primary" name="btnSaveStaff" value="Save"/>
