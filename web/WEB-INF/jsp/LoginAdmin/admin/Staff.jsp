...
<html class="fixed">
    ...
    <head>
        ...
        <title>Staff Page | Baus Gear Admin</title>
                ...
                <section role="main" class="content-body">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title">List Staffs</h2>
                        </header>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-md">
                                        <form action="btnAddStaff.htm">
                                            <button value="btnAddStaff" class="btn btn-primary">Add New Staff <i class="fa fa-plus"></i></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    <c:forEach var="rows" items="${listStaff}">
                                        <tr class="gradeX">
                                            ...
                                            <td>${rows.emailAdmin}</td>
                                            <td>${rows.statusAdmin}</td>
                                            <c:url var="editStaff" value="editStaff.htm">
                                                <c:param name="txtIdAdmin" value="${rows.idAdmin}"/>
                                                <c:param name="txtNameAdmin" value="${rows.nameAdmin}"/>
                                                <c:param name="txtAddressAdmin" value="${rows.addressAdmin}"/>
                                                <c:param name="txtEmailAdmin" value="${rows.emailAdmin}"/>
                                                <c:param name="txtPhoneAdmin" value="${rows.phoneAdmin}"/>
                                                <c:param name="txtStatusAdmin" value="${rows.statusAdmin}"/>
                                                <c:param name="txtUsernameAdmin" value="${rows.usernameAdmin}"/>
                                                <c:param name="txtPasswordAdmin" value="${rows.passwordAdmin}"/>
                                                <c:param name="txtImageAdmin" value="${rows.imageAdminST}"/>
                                            </c:url>
                                            <td class="actions">
                                                <a href="${editStaff}"><i class="fa fa-pencil"></i></a>
                                                    <c:url var="delete" value="deleteStaff.htm">
                                                        <c:param name="idAdmin" value="${rows.idAdmin}"/>
                                                    </c:url>
