...
<html class="fixed">
    ...
    <head>
        <!-- Basic -->
        <meta charset="UTF-8">
        <title>Add Catagories Page | Baus Gear Admin</title>
                            ...
                            <form  id="form" action="Ahihihi.htm" class="form-horizontal">
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <h2 class="panel-title">Create New Catagories</h2>
                                    ...
                                    <footer class="panel-footer">
                                        <div class="row">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <input type="submit"  class="btn btn-primary" name="btnSaveNameCatagories" value="Save"/>
