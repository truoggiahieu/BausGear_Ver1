...
<html class="fixed">
    ...
    <head>
        ...
        <title>Staffs Details Page | Baus Admin Page</title>
                    ...
                    <div id="userbox" class="userbox">
                        <a href="#" data-toggle="dropdown">
                            <figure class="profile-picture">
                                <img src="Hinh/${image2}" alt="${username}" class="img-rounded" data-lock-picture="Hinh/${image2}" />
                            </figure>
                            <div class="profile-info" data-lock-name="${username}" data-lock-email="${email2}">
                                ...
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <p class="panel-subtitle">
                                            Dashboard > <a href="btnStaff.htm"> Staff </a>
                                        </p>
                                    </header>
                                    <div class="panel-body">
                                        <c:forEach var="rows" items="${listStaff}">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6">
                                                    <p class="form-control-static">
                                                        <img src="Hinh/${rows.imageAdminST}" width="200"/></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtUsernameAdmin" class="form-control" value="${rows.usernameAdmin}"required disabled="true"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Password <span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="Password" name="txtPasswordAdmin" class="form-control" value="${rows.passwordAdmin}"required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Fullname<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtNameAdmin" class="form-control" value="${rows.nameAdmin}"required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="inputSuccess">Status</label>
                                                <div class="col-sm-9">
                                                    <select class="form-control mb-md" name="txtStatusAdmin">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtEmailAdmin" class="form-control" value="${rows.emailAdmin}"required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Phone<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtPhoneAdmin" class="form-control" value="${rows.phoneAdmin}"required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Address<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtAddressAdmin" class="form-control" value="${rows.addressAdmin}"required/>
                                                </div>
                                            </div>
                                        </c:forEach>
                                    </div>
                                    <footer class="panel-footer">
                                        <div class="row">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <input type="submit"  class="btn btn-primary" name="btnUpdateStaff" value="Update"/>
