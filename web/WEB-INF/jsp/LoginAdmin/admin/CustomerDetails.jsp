...
<html class="fixed">
    ...
    <head>
        ...
        <title>Customer Details Page | Baus Admin Page</title>
                                ...
                                <section class="panel">
                                    <header class="panel-heading">
                                        ...
                                        <p class="panel-subtitle">
                                            Dashboard > <a href="btnCustomers.htm"> Customer </a>
                                        </p>
                                    </header>
                                    <div class="panel-body">
                                        <c:forEach var="rows" items="${listCustomer}">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6">
                                                    <p class="form-control-static">
                                                        <img src="Hinh/${rows.imageCustomer}" width="200"/></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class=" col-md-3 control-label">Id Customer</label>
                                                <div class="col-lg-6">
                                                    <p class="form-control-static">${rows.idCustomer}</p>
                                                    <input type="hidden" name="txtIdCustomer" value="${rows.idCustomer}"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Username<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtUsernameCustomer" class="form-control" value="${rows.usernameCustomer}"required disabled="true"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Password <span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="Password" name="txtPasswordCustomer" class="form-control" value="${rows.passwordCustomer}"required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Fullname<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtNameCustomer" class="form-control" value="${rows.nameCustomer}"required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="inputSuccess">Status</label>
                                                <div class="col-sm-9">
                                                    <select class="form-control mb-md" name="txtStatusCustomer">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtEmailCustomer" class="form-control" value="${rows.emailCustomer}"required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Phone<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtPhoneCustomer" class="form-control" value="${rows.phoneCustomer}"required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Address<span class="required">*</span></label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtAddressCustomer" class="form-control" value="${rows.addressCustomer}"required/>
                                                </div>
                                            </div>
                                        </c:forEach>
                                    </div>
                                    <footer class="panel-footer">
                                        <div class="row">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <input type="submit"  class="btn btn-primary" name="btnUpdateCustomer" value="Update"/>
