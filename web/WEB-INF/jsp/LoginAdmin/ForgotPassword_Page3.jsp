                    ...
                    <div class="panel-body">
                        ...
                        <form action="btnChangePassword.htm" method="post">
                            ...
                            <div class="form-group mb-lg">
                                ...
                                <div class="input-group input-group-icon">
                                    <input name="txtConfirmPassword" type="password" class="form-control input-lg" />
                                    <span class="input-group-addon">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 text-right">
                                    <button type="submit" name="btnChangePassword" id="sent" class="btn btn-primary hidden-xs">Update</button>
