        ...
        <div class="site-wrap">
            ...
            <div class="site-section">
                <div class="container">
                    ...
                    <div class="row mb-5">
                        <form class="col-md-12" id="update_form" action="../cartbean/update.htm" method="get">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-3" style="max-width: 120px;">
                                                            ...
                                                            <input type="text" hidden="true" value="${rows.value.sanpham.id}" name="txtID"/>
                                                            <input type="text" class="form-control text-center"  name="txtQuantity" value="${rows.value.quantity}" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
                        ...
                        <div class="col-md-6">
                            <div class="row mb-5">
                                ...
                                <div class="col-md-6 mb-3 mb-md-0">
                                    <button type="submit" form="update_form" class="btn btn-primary btn-sm btn-block" >Update Cart</button>
                                </div>
