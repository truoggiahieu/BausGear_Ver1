    ...
    <body>
        <form action="registerCustomer.htm" method="POST">
            <div class="container">
                ...
                <input type="text" placeholder="Enter Full Name" name="txtName" required>

                <label for="email"><b>Email</b></label>
                <input type="text" placeholder="Enter Email" name="txtEmail" required>

                <label for="uname"><b>Phone</b></label>
                <input type="text" placeholder="Enter Phone Number" name="txtPhone" required>
                ...
                <input type="file" placeholder="Choose" name="txtImage" required>
                <hr>
                
                <button type="submit" class="registerbtn" name="registerCustomer">Register</button>
            </div>

            <div class="container signin">
                <p>Already have an account? <a href="index.htm">Sign in</a>.</p>
            </div>
        </form>        
    </body>
</html>
